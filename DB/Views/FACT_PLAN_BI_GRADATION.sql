...
union all     
select  'Инвестиции в открытие магазина' as MEASURE_NAME -- Название показателя
      , p._Fld25022       as START_DT -- Дата начала планового периода
      , p._Fld25023       as END_DT -- Дата окончания планового периода
      , pg._Document24866_IDRRef  as ID_PLAN_DOC_ID -- Ссылка на документ планирования
      , pg._Fld24882RRef  as ID_STOCK -- Ссылка на магазин
      , null			  as [PLAN] -- Плановое значение показателя
      , pg._Fld24883      as [FACT] -- Фактическое значение показателя
      , null as [IS_MANUAL_CORRECTION] -- Флаг ручной коррекции
